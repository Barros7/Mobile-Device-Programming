...
public class ExamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewQuestionCount = findViewById(R.id.text_view_quetion_count);
        ...
        radioBtn4 = findViewById(R.id.radio_button4);
        btnAnswer = findViewById(R.id.button_answer);

        textColorDefaultRb = radioBtn1.getTextColors();
    ...
    private void showNextQuestion(){
        radioBtn1.setTextColor(textColorDefaultRb);
        radioBtn2.setTextColor(textColorDefaultRb);
        radioBtn3.setTextColor(textColorDefaultRb);
        radioBtn4.setTextColor(textColorDefaultRb);
    ...
    public void onBackPressed() {
        if(backPressedTime + 2000 > System.currentTimeMillis()){
            ...
            Toast.makeText(this, "Pressed back again to finish", Toast.LENGTH_SHORT).show();
        }
    ...
    private  void checkAnswer(){
        ...
        int answerNumber = radioBtnGroup.indexOfChild(rbSelected) +1;
